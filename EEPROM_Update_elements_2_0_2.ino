...
int address = 0;
int RadioChannel = 1;               // This is the RF remote channel A = 1, B = 2, C = 3.  D button is being reserved for emergancy stop.
...
unsigned long FireTime = 100;        // time the relay will fire the cue - Stored delays array [33] - update or read main version at EEPROM address  197-202
...
//  }
  ...
  Serial.print("ScreenSleep = ");Serial.println(EEPROM.read(217));
  EEPROM.update(218,RadioChannel);
  Serial.print("RadioChannel = ");Serial.println(EEPROM.read(218));  
